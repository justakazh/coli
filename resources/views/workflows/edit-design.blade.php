                    ...
                    <div class="col-md-12"> 
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <textarea id="drawflow_data" name="drawflow_data">{{ old('drawflow_data', $workflow->drawflow_data ?? '') }}</textarea>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter workflow description">{{ old('description', $workflow->description ?? '') }}</textarea>
                                                </div>
                                            </div>
      ...
      <div class="modal-body">
        <div class="mb-4">
            ...
            <ul class="mb-3 ps-3">
                ...
                <li class="mb-2">To update the workflow, click the <b>Update Workflow</b> button.</li>
                <li class="mb-2">To edit a task, click the <b>Edit</b> icon on a node.</li>
                <li class="mb-2">To delete a task, click the <b>Delete</b> icon on a node.</li>
            </ul>
        </div>
        <div class="mb-4">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Load existing drawflow data for edit
        @php
            $drawflowData = old('drawflow_data', $workflow->drawflow_data ?? '');
        @endphp
        @if(!empty($drawflowData))
            try {
                let oldDrawflow = JSON.parse(@json($drawflowData));
